...
const Edit = ({ initialValues, onHandleEdit }) => {

  const { dessert } = useSelector((state) => state.products);
    ...
    <>
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-xl">
        <Formik
          ...
          onSubmit={(values) => {
            onHandleEdit(dessert._id, values);
          }}
        >
          {({
            values,
            ...
            <form className="space-y-2" onSubmit={handleSubmit}>
              ...
              <div className="relative z-0 w-full mb-6 group">
                ...
                {errors.sweet && (
                  <div className="text-red-500">{errors.sweet}</div>
                )}
              </div>
                ...
                {values?.tags.map((tag, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() =>
                        handleRemoveWord(index, values, setFieldValue)
                      }
                    >
                      X
                    </button>
              ...
              {errors.newWord && (
                <div className="text-red-500">{errors.newWord}</div>
              )}
              <div className="relative z-0 w-full mb-6 group">
                <input
                  type="text"
